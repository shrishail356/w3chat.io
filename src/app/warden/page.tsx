        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-gray-400 text-lg">
              An AI agent that enables seamless Web3 interactions on the Warden
              Protocol chain. Whether it's interacting with smart contracts or
              creating new ones, Warden simplifies your blockchain experience.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
