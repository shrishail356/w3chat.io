...
const BATCH_TRANSFER_ADDRESS = '0xfaFF0A96344808e35E34EbFe15B2f2D32fb820d1';
                  ...
                  <>
                    ...
                    <div className="mt-4 space-y-2">
                      {transactionHashes.map((hash, index) => (
                        <a
                          key={hash}
                          href={networkType === "base_sepolia" ? `https://sepolia.basescan.org/tx/${hash}` : `https://basescan.org/tx/${hash}`}
                          target="_blank"
