        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-gray-400 text-lg">
              Automate your blockchain actions effortlessly! Schedule
              transactions, token swaps, and more—whether it's sending at a
              specific time or executing trades based on price conditions. Set
              it and let Scheduler handle the rest!
            </p>
          </motion.div>
        </motion.div>
        <motion.div
