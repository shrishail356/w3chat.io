...
import { Bot, Menu, X, ChevronDown, LogOut, Copy, ExternalLink } from "lucide-react";
          ...
          <div className="p-4 border-b border-white/10">
            ...
            <div className="flex gap-2 mt-3">
              ...
              >
                ...
                View on {networkType === 'mainnet' ? 'BaseScan' : 'Base Sepolia'}
              </button>
            </div>
          </div>
  ...
  const NetworkSelector = () => {
    ...
    return (
      <div className="relative">
        ...
        >
          {networkType === 'incorrect' ? 'Incorrect Network' : networkType === 'sepolia' ? 'Base Sepolia' : 'Base'}
          <svg
        ...
        {isOpen && (
          <div className="absolute z-50 mt-3 w-full bg-[#112240] border border-white/20 rounded-lg shadow-lg">
            <button
              onClick={() => {
      ...
      <div className="h-full px-2 sm:px-4 flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Link href="/" className="group flex items-center space-x-3">
            ...
            <span className="hidden sm:inline text-xl font-bold tracking-tight">W3Chat.io</span>
          </Link>
        </div>
