...
function UserProfileButton() {
  ...
  const openExplorer = () => {
    if (user.wallet?.address) {
      const baseUrl = networkType === 'arbitrum_mainnet'
          ...
          <div className="p-4 border-b border-white/10">
            ...
            <div className="flex gap-2 mt-3">
              ...
              >
                ...
                View on {networkType === 'arbitrum_mainnet' ? 'Arbitrum Mainnet' : 'Arbitrum Sepolia'}
              </button>
            </div>
          </div>
  ...
  const NetworkSelector = () => {
    ...
    return (
      <div className="relative">
        ...
        >
          <span className="mr-4">
            {networkType === 'incorrect' ? 'Incorrect Network' : networkType === 'arbitrum_sepolia' ? 'Arbitrum Sepolia' : 'Arbitrum'}
          </span>
          <svg
        ...
        {isOpen && (
          <div className="absolute z-50 mt-3 w-full bg-[#112240] border border-white/20 rounded-lg shadow-lg">
            ...
            <button
              onClick={() => {
                setNetworkType('arbitrum_sepolia');
                setIsOpen(false);
              }}
